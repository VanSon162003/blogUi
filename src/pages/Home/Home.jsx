            ...
            <div className={styles.home}>
                        ...
                        <div className={styles.heroContent}>
                            <div className={styles.heroText}>
                                ...
                                <p className={styles.heroDescription}>
                                    Discover cutting-edge tutorials, best
                                    practices, and industry insights from
                                    experienced developers. Stay ahead with the
                ...
                <div className="container">
                    ...
                    <section className={styles.section}>
                        ...
                        <TopicList maxTopics={3} topics={topics} />
                        <div className={styles.sectionAction}>
                        ...
                        <div className={styles.newsletterCard}>
                            <div className={styles.newsletterContent}>
                                ...
                                <p className={styles.newsletterDescription}>
                                    Get the latest tutorials and insights
                                    delivered to your inbox weekly. Join our
